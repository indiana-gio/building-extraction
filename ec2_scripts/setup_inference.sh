...
cd ..
aws s3 cp s3://gsci-2026-building-footprint-057331986207-us-east-2-an/validation/labels/ Project/labels/ --recursive
aws s3 cp s3://gsci-2026-building-footprint-057331986207-us-east-2-an/validation/RawTiles10_3inch/ Project/RawTiles10_3inch/ --recursive
